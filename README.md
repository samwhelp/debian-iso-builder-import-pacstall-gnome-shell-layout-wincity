...
| Config |
| ------ |
| [~/.config](https://github.com/samwhelp/debian-iso-builder-import-pacstall-gnome-shell-layout-wincity/tree/main/profile/template/asset/overlay/etc/skel/.config) |
| [/usr/share/glib-2.0/schemas](https://github.com/samwhelp/debian-iso-builder-import-pacstall-gnome-shell-layout-wincity/tree/main/profile/template/asset/overlay/usr/share/glib-2.0/schemas) |
| [/etc/dconf/db/distro.d](https://github.com/samwhelp/debian-iso-builder-import-pacstall-gnome-shell-layout-wincity/tree/main/profile/template/asset/overlay/etc/dconf/db/distro.d) |
...
> clone [debian-iso-builder-import-pacstall-gnome-shell-layout-wincity](https://github.com/samwhelp/debian-iso-builder-import-pacstall-gnome-shell-layout-wincity)

``` sh
git clone https://github.com/samwhelp/debian-iso-builder-import-pacstall-gnome-shell-layout-wincity.git
```


> change dir to `debian-iso-builder-import-pacstall-gnome-shell-layout-wincity`

``` sh
cd debian-iso-builder-import-pacstall-gnome-shell-layout-wincity
```
...
> change dir to `~/work/debian-iso-builder-import-pacstall-gnome-shell-layout-wincity/iso-profile`

``` sh
cd ~/work/debian-iso-builder-import-pacstall-gnome-shell-layout-wincity/iso-profile
```
...
> The resulting ISO file will be placed on `~/work/debian-iso-builder-import-pacstall-gnome-shell-layout-wincity/iso-profile/dist`
